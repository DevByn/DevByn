...
**Certifications** · SQL Developer (SQLD) · Microsoft Azure AI Fundamentals (AI-900) · AI 프롬프트 활용능력div align="center">
...
- **장르:** 실감 콘텐츠 | **역할**: TPM & User Interaction Design | **팀 구성**: 아트 1 · 프로그래밍 4 
